...
=======
CREATE TABLE parent (
	IdParent			INT							GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE tarif (
	IdTarif			        INT							GENERATED BY DEFAULT AS IDENTITY,
	...
	CREATE TABLE garde (
	IdGarde			        INT						 GENERATED BY DEFAULT AS IDENTITY,
	HeureArrivee            DATE                     NOT NULL,
	HeureDepart        	    DATE                     NOT NULL,
	NombreRepas             INT                      NOT NULL,
